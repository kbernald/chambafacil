...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2014 a las 20:26:31
...
CREATE TABLE IF NOT EXISTS `cargo` (
  ...
  `desp_cargo` varchar(500) NOT NULL
...
CREATE TABLE IF NOT EXISTS `empresa_emp` (
  ...
  `sitio_web` varchar(70) COLLATE utf8_unicode_ci NOT NULL,
  `id_dep` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `experiencia_laboral` (
  `id_explab` int(11) NOT NULL AUTO_INCREMENT,
  `id_usu` int(11) NOT NULL,
  `id_perfil` int(11) NOT NULL,
  `id_area` int(11) NOT NULL,
  `institucion_empresa` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `experiencia_laboral` (`id_explab`, `id_usu`, `id_perfil`, `id_area`, `institucion_empresa`, `funciones`, `fech_ini`, `fech_fin`, `Contacto`, `num_contacto`, `Moti_fin`, `Documentor`, `experiencia_laboralcol`) VALUES
(1, 12, 1, 0, 'OLTASIS', 'Analista Programador', '2014-02-01', '2014-11-28', '', '', '', '', 'Analista Programador'),
(5, 12, 0, 0, 'GRUPO ROMERO', 'Programador', '2013-01-01', '2013-07-28', '', '', '', '', 'Programador'),
(6, 12, 0, 0, 'GRUPO ADMIRA', 'Analista Programador', '2014-01-01', '2014-11-01', '', '', '', '', 'Analista Programador');
...
CREATE TABLE IF NOT EXISTS `informac_personal_infp` (
  ...
  `Tel_celular_usr` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
  ...
  KEY `id_ciu_idx` (`id_prov`),
  KEY `id_dist_idx` (`id_dist`),
  KEY `id_sitlab_idx` (`id_sitlab`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=9 ;

--
-- Volcado de datos para la tabla `informac_personal_infp`
--

INSERT INTO `informac_personal_infp` (`id_inf_basica`, `docid`, `id_tipdoc`, `num_doc`, `Nombre_usr`, `Apel_pat_usr`, `Apel_mat_usr`, `Sex_usr`, `fec_nac_usr`, `Tel_celular_usr`, `Tel_fijo_usr`, `id_paisnac`, `id_dep`, `id_prov`, `id_dist`, `Direccion_usr`, `id_sitlab`, `categoria`, `idusr`) VALUES
(8, '', 1, 72386480, 'Eldo Felipe', 'Montalvan', 'Moscol', '1', '1991-09-11', '987833903', '017951131', 1, 15, 1, 1, 'Av. Las Flores Paradero 22 - S.J.L', 1, '', 12);
...
--
-- Estructura de tabla para la tabla `pais_nac`
--

CREATE TABLE IF NOT EXISTS `pais_nac` (
  `id_paisnac` int(11) NOT NULL,
  `nom_piasnac` varchar(45) NOT NULL,
  `des_paisnac` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `referencia_personal` (
  ...
  `refe_per` varchar(45) NOT NULL,
  `nom_cont` varchar(45) NOT NULL,
  `ape_cont` varchar(45) NOT NULL,
  `email` varchar(45) NOT NULL,
  `telf_cont` int(11) NOT NULL,
  `relacion` varchar(40) NOT NULL,
  `puesto_cont` varchar(45) NOT NULL,
  `nom_inst` varchar(45) NOT NULL,
  `tipo_refe` varchar(45) NOT NULL,
  `id_tipeoc` int(11) NOT NULL,
  `id_usr` int(11) NOT NULL,
  PRIMARY KEY (`id_ref`)
...
INSERT INTO `referencia_personal` (`id_ref`, `refe_per`, `nom_cont`, `ape_cont`, `email`, `telf_cont`, `relacion`, `puesto_cont`, `nom_inst`, `tipo_refe`, `id_tipeoc`, `id_usr`) VALUES
(1, '', 'Ricardo', 'Olivari Talledo', 'eldo_1591@hotmail.com', 2147483647, 'Jefe Inmediato', 'Gerente General', 'OLTASIS E.I.R.L', '', 0, 12);
...
--
-- Volcado de datos para la tabla `situacion_laboral_sitlab`
--

INSERT INTO `situacion_laboral_sitlab` (`id_sitlab`, `Desc_sitlab`) VALUES
...
--
-- Volcado de datos para la tabla `tipo_tip`
--

INSERT INTO `tipo_tip` (`id_tipo`, `desc_tip`) VALUES
(1, 'Evaluador'),
(2, 'Empresa'),
(3, 'Postulante');
