                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                   <!-- <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#"  class="dropdown-toggle" data-toggle="modal" data-target="#login"><i class="fa fa-user"></i> Iniciar Sesión</a>
                        </li>
                        <li class="dropdown">
                            <!-- Button trigger modal -->
                            <button id="registrarme" class="btn btn-navbar btn-danger" data-toggle="modal" data-target="#register">Registrate</button>
                        </li>
                    </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <h1>ERROR AL LOGUEARTE</h1>
            <p>Vuelva a intentar porfavor</p>
            <h1>&nbsp;</h1>
        </div>
      </div>
    </div>
  ...
  <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <h3 class="footer-title">Footer Widget</h3>
          <p>
            ...
            Curabitur orci dui, imperdiet vel <a href="#">tristique congue</a>.
          </p>
